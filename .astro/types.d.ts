...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"astro-netlify-install copy.mdx": {
	id: "astro-netlify-install copy.mdx";
  slug: "astro-netlify-install-copy";
  body: string;
  collection: "blog";
...
"dj-basic-crud copy.mdx": {
	id: "dj-basic-crud copy.mdx";
  slug: "dj-basic-crud-copy";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".mdx"] };
